 ...
 * @author KARAN
 */
public class cfile extends javax.swing.JFrame {

    /**
     * Creates new form cfile
     */
    File f;
    public cfile() {
        initComponents();
    ...
    private void initComponents() {
        ...
        label.setText("Select Movie Poster");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cfile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
